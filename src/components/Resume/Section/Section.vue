  ...
  <div class="sectionContainer">
    <!--        @Reviewer
            ...
            they start or finish a certain job.  So although I store these values as the first of the month on either
              ...
              with whether or not a date contains a time.  I need to go back and check if this is going to be a
              problem since I don't want, for example, May 1st, 2019 to show up as 04/2019 because the browser thinks
