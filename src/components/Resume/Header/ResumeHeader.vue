    ...
    <div>
        <div :class="['header']">
            <div class="headerMain">
                <div class="name">{{header.strApplicantFirstName}} {{header.strApplicantLastName}}</div>
                <div class="bstrTitle">{{header.strResumeTitle}}</div>
            </div>
            <div :class="[{mobile: appWidthDescription === 'small'},'headerDetails']">
                <HeaderShortText class="first">{{header.strDisplayEmail}}</HeaderShortText>
        ...
        <div v-if="hasSummary"
             class="summary">{{header.strSummary}}</div>
    </div>
</template>
...
<script>
  ...
  export default {
    ...
    computed:{...mapState({
      ...
      hasSummary(){return this.header.summary !== ''},
      appWidthDescription(){ return this.$store.state.appWidthDescription}
    },
    components:{
      HeaderShortText
    }
